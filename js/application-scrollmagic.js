...
$(document).ready(function() {
	...
	// build scene
    scene = new ScrollScene({triggerElement: "#marker-debut", duration: windowHeight*3})
        .setPin("#main")
        .addTo(controller)
        .addIndicators();

    var tween = new TimelineMax()
        .add(TweenMax.fromTo("#pres-contact", 5, {top: -300}, {top: '30vh', ease: Back.easeInOut}))
    ...
    scene = new ScrollScene({triggerElement: "#marker-debut", duration: 300})
        .setTween(tween)
        .addTo(controller);
    ...
    scene = new ScrollScene({triggerElement: "#marker-contact-away", duration: windowHeight*1/10})
        .setTween(tween)
        .addTo(controller)
        .addIndicators();
    ...
    scene = new ScrollScene({triggerElement: "#marker-technicals", duration: 300})
        .setTween(tween)
        .addTo(controller);
    ...
    scene = new ScrollScene({triggerElement: "#marker-show-training", duration: 300})
        .setTween(tween)
        .addTo(controller)
        .addIndicators();
